...
public enum WebApplicationType {
	...
	static WebApplicationType deduceFromClasspath() {
		if (ClassUtils.isPresent(WEBFLUX_INDICATOR_CLASS, null) && !ClassUtils.isPresent(WEBMVC_INDICATOR_CLASS, null)
			...
			return WebApplicationType.REACTIVE; // jxh: org.springframework.web.reactive.DispatcherHandler
		}
		for (String className : SERVLET_INDICATOR_CLASSES) { // jxh: jakarta.servlet.Servlet、org.springframework.web.context.ConfigurableWebApplicationContext
